...
// Query tool strings
export var densityStrings = ['Low', 'Medium', 'High', 'Very High'];
export var landValueStrings = ['Slum', 'Lower Class', 'Middle Class', 'High'];
export var crimeStrings = ['Safe', 'Light', 'Moderate', 'Dangerous'];
export var pollutionStrings = ['None', 'Moderate', 'Heavy', 'Very Heavy'];
export var rateStrings = ['Declining', 'Stable', 'Slow Growth', 'Fast Growth'];
export var zoneTypes = ['Clear', 'Water', 'Trees', 'Rubble', 'Flood', 'Radioactive Waste',
...
// months
export var months = ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun',
  'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'];

// Tool strings
export var toolMessages = {
  noMoney: 'Insufficient funds to build that',
  needsDoze: 'Area must be bulldozed first'
};

// Message strings
export var neutralMessages = {};

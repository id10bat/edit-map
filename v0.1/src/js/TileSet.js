...
// Tiles ต้องเป็น สี่เหลี่ยม 16px 
var TILE_SIZE = 16;
...
// เราคาดว่าจะมีรูปสี่เหลี่ยมจัตุรัส, และของที่จำเป็น width/height
...
// We paint the image onto a canvas คือ เราสามารถแยกมันออกได้
var c = document.createElement('canvas');
c.width = tileWidth;
c.height = tileWidth;
var cx = c.getContext('2d');

// นับจำนวนกระเบื้องที่เราสร้างขึ้น
